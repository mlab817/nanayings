...
const state = () => {
	return {
		...
		stores: {
			'ce51404b-7ae1-43a3-99ca-576fb0a0cf32': { name: 'Anson\'s Supermarket' },
			'464e7f48-1137-4fdc-acb6-ccbf60c0c29a': { name: 'Landmark' },
			'c1ceb16c-d7cd-4a12-8fce-e1c2cb33a45a': { name: 'Wonderbake Inc' },
			'745df4fb-2cab-42dc-b931-2a4cd05ece86': { name: 'Chocolate Lovers Inc' },
			'd62273e0-f251-46a9-af6a-bcda6671be86': { name: 'Super 8 Supermarket' },
			ID6: { name: 'Market' }
		}
	}
}
